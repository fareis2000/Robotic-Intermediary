...
void serialEvent (Serial myPort) {
  ...
  if (data != null) {
    ...
    if (index1 > 0) {  // Garante que o ponto foi encontrado
      ...
      try {
        ...
        println("Erro ao converter valores: " + e.getMessage());
      }
    }
  }
}
...
void drawText() {
  ...
  textSize(25);
  fill(98, 245, 60);
  translate(300+960*cos(radians(30)), 780-960*sin(radians(30)));
  rotate(-radians(-60));
  text("30º",0,0);
  resetMatrix();
  translate(400+960*cos(radians(60)), 920-960*sin(radians(60)));
  rotate(-radians(-30));
  text("60", 0, 0);
  resetMatrix();
  ...
  text("120", 0, 0);
  resetMatrix();
  translate(840+960*cos(radians(150)), 920-960*sin(radians(150)));
  rotate(radians(-60));
  text("150", 0, 0);
  popMatrix();
}
